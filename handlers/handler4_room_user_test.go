...
func TestPutRoomUsers(t *testing.T) {
	...
	testTable := []testRecord{
		...
		},
		{
			...
			`,
			out:            `(?m)^{"roomUsers":\[{"roomId":"custom\-room\-id","userId":"custom\-user\-id\-1","unreadCount":0,"metaData":{},"created":[0-9]+},{"roomId":"custom\-room\-id","userId":"custom\-user\-id\-2","unreadCount":0,"metaData":{},"created":[0-9]+},{"roomId":"custom\-room\-id","userId":"custom\-user\-id\-3","unreadCount":0,"metaData":{},"created":[0-9]+}\]}$`,
			httpStatusCode: 200,
		},
		{
			testNo: 3,
	...
	testTable := []testRecord{
		{
			...
			`,
			out:            `(?m)^{"roomId":"custom-room-id","userId":"custom-user-id-1","unreadCount":100,"metaData":{},"created":[0-9]+}$`,
			httpStatusCode: 200,
		},
		{
			testNo: 2,
			...
			`,
			out:            `(?m)^{"roomId":"custom-room-id","userId":"custom-user-id-1","unreadCount":100,"metaData":{"key":"value"},"created":[0-9]+}$`,
			httpStatusCode: 200,
		},
		{
			testNo: 3,
			...
			`,
			out:            `(?m)^{"roomId":"custom-room-id","userId":"custom-user-id-1","unreadCount":200,"metaData":{"key2":"value2"},"created":[0-9]+}$`,
			httpStatusCode: 200,
		},
		{
			testNo: 4,
