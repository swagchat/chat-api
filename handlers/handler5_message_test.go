	...
	testTable := []testRecord{
		{
			...
			out:            `(?m)^{"messageId":"[a-z0-9-]+","roomId":"custom-room-id","userId":"custom-user-id-1","type":"text","payload":{"text":"Welcome to swagchat\!"},"created":[0-9]+,"modified":[0-9]+}$`,
			httpStatusCode: 200,
		},
		{
			testNo:         2,
			messageId:      createMessageIds[1],
			out:            `(?m)^{"messageId":"[a-z0-9-]+","roomId":"custom-room-id","userId":"custom-user-id-1","type":"text","payload":{"text":"Hi custom\-room\-id\-1\!"},"created":[0-9]+,"modified":[0-9]+}$`,
			httpStatusCode: 200,
		},
		{
			testNo:         3,
			messageId:      createMessageIds[2],
			out:            `(?m)^{"messageId":"[a-z0-9-]+","roomId":"custom-room-id","userId":"custom-user-id-1","type":"text","payload":{"text":"How\'s it going\?"},"created":[0-9]+,"modified":[0-9]+}$`,
			httpStatusCode: 200,
		},
		{
			testNo:         4,
			messageId:      createMessageIds[3],
			out:            `(?m)^{"messageId":"[a-z0-9-]+","roomId":"custom-room-id","userId":"custom-user-id-1","type":"text","payload":{"text":"Good\!"},"created":[0-9]+,"modified":[0-9]+}$`,
			httpStatusCode: 200,
		},
		{
			testNo:         5,
			messageId:      createMessageIds[4],
			out:            `(?m)^{"messageId":"[a-z0-9-]+","roomId":"custom-room-id","userId":"custom-user-id-2","type":"text","payload":{"text":"Welcome to swagchat\!"},"created":[0-9]+,"modified":[0-9]+}$`,
			httpStatusCode: 200,
		},
		{
			testNo:         6,
			messageId:      createMessageIds[5],
			out:            `(?m)^{"messageId":"[a-z0-9-]+","roomId":"custom-room-id","userId":"custom-user-id-2","type":"image","payload":{"mime":"image\/png","sourceUrl":"http\:\/\/example.com\/source\.png","thumbnailUrl":"http\:\/\/example.com\/thumbnail\.png"},"created":[0-9]+,"modified":[0-9]+}$`,
			httpStatusCode: 200,
		},
		{
			testNo:         7,
			messageId:      createMessageIds[6],
			out:            `(?m)^{"messageId":"[a-z0-9-]+","roomId":"custom-room-id","userId":"custom-user-id-2","type":"not-exist-type","payload":{},"created":[0-9]+,"modified":[0-9]+}$`,
			httpStatusCode: 200,
		},
		{
			testNo:         8,
			messageId:      createMessageIds[7],
			out:            `(?m)^{"messageId":"[a-z0-9-]+","roomId":"custom-room-id","userId":"custom-user-id-2","type":"text","payload":{"text":"Bye\!"},"created":[0-9]+,"modified":[0-9]+}$`,
			httpStatusCode: 200,
		},
		{
			testNo:         9,
