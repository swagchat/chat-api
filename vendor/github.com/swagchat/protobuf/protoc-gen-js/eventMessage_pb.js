...
goog.exportSymbol('proto.swagchat.protobuf.UserJoinEventPayload', null, global);
 ...
 * @constructor
 */
proto.swagchat.protobuf.UserJoinEventPayload = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.swagchat.protobuf.UserJoinEventPayload.repeatedFields_, null);
};
goog.inherits(proto.swagchat.protobuf.UserJoinEventPayload, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.swagchat.protobuf.UserJoinEventPayload.displayName = 'proto.swagchat.protobuf.UserJoinEventPayload';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.swagchat.protobuf.UserJoinEventPayload.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.swagchat.protobuf.UserJoinEventPayload.prototype.toObject = function(opt_includeInstance) {
  return proto.swagchat.protobuf.UserJoinEventPayload.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.swagchat.protobuf.UserJoinEventPayload} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.swagchat.protobuf.UserJoinEventPayload.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.swagchat.protobuf.UserJoinEventPayload}
 */
proto.swagchat.protobuf.UserJoinEventPayload.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.swagchat.protobuf.UserJoinEventPayload;
  return proto.swagchat.protobuf.UserJoinEventPayload.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.swagchat.protobuf.UserJoinEventPayload} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.swagchat.protobuf.UserJoinEventPayload}
 */
proto.swagchat.protobuf.UserJoinEventPayload.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.swagchat.protobuf.UserJoinEventPayload.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.swagchat.protobuf.UserJoinEventPayload.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.swagchat.protobuf.UserJoinEventPayload} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.swagchat.protobuf.UserJoinEventPayload.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.swagchat.protobuf.UserJoinEventPayload.prototype.getRoomId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.swagchat.protobuf.UserJoinEventPayload.prototype.setRoomId = function(value) {
  jspb.Message.setField(this, 1, value);
};


proto.swagchat.protobuf.UserJoinEventPayload.prototype.clearRoomId = function() {
  jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {!boolean}
 */
proto.swagchat.protobuf.UserJoinEventPayload.prototype.hasRoomId = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 */
proto.swagchat.protobuf.UserJoinEventPayload.prototype.getUsersList = function() {
...
proto.swagchat.protobuf.UserJoinEventPayload.prototype.setUsersList = function(value) {
 ...
 */
proto.swagchat.protobuf.UserJoinEventPayload.prototype.addUsers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.swagchat.protobuf.MiniUser, opt_index);
};


proto.swagchat.protobuf.UserJoinEventPayload.prototype.clearUsersList = function() {
  this.setUsersList([]);
};
