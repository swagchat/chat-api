...
type subscriptionStore interface {
	...
	SelectSubscription(roomID, userID string, platform int) (*model.Subscription, error)
	...
	SelectDeletedSubscriptionsByUserIDAndPlatform(userID string, platform int) ([]*model.Subscription, error)
